...
object ObjectUtils {
  ...
  /**
    ...
    * @since 3.5
    */
  def allNotNull(values: Any*): Boolean = {
...
//      }
//      @SuppressWarnings(Array("unchecked")) // OK because input is of type T val checked: T = result.asInstanceOf[T]
//      return checked
//    }
//    null.asInstanceOf[T]
//  }
...
//    else if (c1 == null) return if (nullGreater) 1
//    else -1
//    else if (c2 == null) return if (nullGreater) -1
//    else 1
//    c1.compareTo(c2)
//  }
//
...
//    if (object1.eq(object2)) return true
...
//
  /**
    ...
    * @since 3.0
    */
  @SafeVarargs def firstNonNull[T](values: T*): T = {
...
//    * @since 3.10
//    */
//  @SafeVarargs def getFirstNonNull[T](suppliers: Supplier[T]*): T = {
//    if (suppliers != null) for (supplier <- suppliers) {
//      if (supplier != null) {
...
//    * @since 3.10
//    */
//  def getIfNull[T](`object`: T, defaultSupplier: Supplier[T]): T =
//    if (`object` != null) `object`
//    else if (defaultSupplier == null) null.asInstanceOf[T]
...
//    */
//  @deprecated def hashCode(obj: Any): Int = { // hashCode(Object) retained for performance, as hash code is often critical
//    if (obj == null) 0
//    else obj.hashCode
//  }
//
...
//    var hash = 1
//    if (objects != null) for (`object` <- objects) {
//      val tmpHash = hashCode(`object`)
...
//    *         {@code null} passed in
//    */
//  def identityToString(`object`: Any): String = {
//    if (`object` == null) return null
//    val name = `object`.getClass.getName
//    val hexString = Integer.toHexString(System.identityHashCode(`object`))
//    val builder = new StringBuilder(name.length + 1 + hexString.length)
//    // @formatter:off
...
//    */
//  @deprecated def identityToString(builder: StrBuilder, `object`: Any): Unit = {
//    Validate.notNull(`object`, "Cannot get the toString of a null object")
//    val name = `object`.getClass.getName
//    val hexString = Integer.toHexString(System.identityHashCode(`object`))
...
//    * @since 2.4
//    */
//  def identityToString(buffer: StringBuffer, `object`: Any): Unit = {
//    Validate.notNull(`object`, "Cannot get the toString of a null object")
//    val name = `object`.getClass.getName
//    val hexString = Integer.toHexString(System.identityHashCode(`object`))
...
//    * @since 3.2
//    */
//  def identityToString(builder: StringBuilder, `object`: Any): Unit = {
//    Validate.notNull(`object`, "Cannot get the toString of a null object")
//    val name = `object`.getClass.getName
//    val hexString = Integer.toHexString(System.identityHashCode(`object`))
//    builder.ensureCapacity(builder.length + name.length + 1 + hexString.length)
...
//    * @since 3.9
//    */
//  def isEmpty(`object`: Any): Boolean = {
//    if (`object` == null) return true
//    if (`object`.isInstanceOf[CharSequence]) return `object`.asInstanceOf[CharSequence].length == 0
//    if (`object`.getClass.isArray) return Array.getLength(`object`) == 0
//    if (`object`.isInstanceOf[util.Collection[_]]) return `object`.asInstanceOf[util.Collection[_]].isEmpty
//    if (`object`.isInstanceOf[util.Map[_, _]]) return `object`.asInstanceOf[util.Map[_, _]].isEmpty
//    false
//  }
//
//  /**
...
//    * @since 3.9
//    */
//  def isNotEmpty(`object`: Any): Boolean = !isEmpty(`object`)
//
//  /**
//    * <p>Null safe comparison of Comparables.</p>
//    *
...
//    val result: T = sort.toArray((sort.size - 1) / 2).asInstanceOf[T]
//    result
//  }
//
//  /**
...
//    Collections.addAll(sort, items)
//    @SuppressWarnings(Array("unchecked")) val result = sort.toArray((sort.size - 1) / 2).asInstanceOf[T]
//    result
//  }
//
//  /**
...
//    * @since 3.0.1
//    */
//  @SafeVarargs def mode[T](items: T*): T = {
...
//    */
//  def notEqual(object1: Any, object2: Any): Boolean = !equals(object1, object2)
//
//  /**
...
//    */
//  @deprecated def toString(obj: Any): String =
//    if (obj == null) StringUtils.EMPTY
//    else obj.toString
//
//  /**
//    * <p>Gets the {@code toString} of an {@code Object} returning
...
//    */
//  @deprecated def toString(obj: Any, nullStr: String): String =
//    if (obj == null) nullStr
//    else obj.toString
//
//  /**
...
//    * @since 3.11
//    */
//  def toString(obj: Any, supplier: Supplier[String]): String =
//    if (obj == null)
