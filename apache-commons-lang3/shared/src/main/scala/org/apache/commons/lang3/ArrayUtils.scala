...
object ArrayUtils {
  ...
  /**
    * An empty immutable {@code Boolean} array.
    */
  val EMPTY_BOOLEAN_OBJECT_ARRAY: Array[JavaBoolean] = new Array[JavaBoolean](0)
  /**
  ...
  /**
    * An empty immutable {@code Byte} array.
    */
  val EMPTY_BYTE_OBJECT_ARRAY: Array[JavaByte] = new Array[JavaByte](0)
  /**
  ...
  /**
    * An empty immutable {@code Double} array.
    */
  val EMPTY_DOUBLE_OBJECT_ARRAY: Array[JavaDouble] = new Array[JavaDouble](0)
  /**
  ...
  /**
    * An empty immutable {@code Float} array.
    */
  val EMPTY_FLOAT_OBJECT_ARRAY: Array[JavaFloat] = new Array[JavaFloat](0)
  /**
  ...
  /**
    * An empty immutable {@code Long} array.
    */
  val EMPTY_LONG_OBJECT_ARRAY: Array[JavaLong] = new Array[JavaLong](0)
  /**
  ...
  /**
    ...
    */
  val EMPTY_OBJECT_ARRAY: Array[Any] = new Array[Any](0)
  /**
  ...
  /**
    * An empty immutable {@code Short} array.
    */
  val EMPTY_SHORT_OBJECT_ARRAY: Array[JavaShort] = new Array[JavaShort](0)
  /**
  ...
  /**
    ...
    */
  def contains(array: Array[Double], valueToFind: Double, tolerance: Double): Boolean =
    indexOf(array, valueToFind, 0, tolerance) != INDEX_NOT_FOUND
  ...
  /**
    ...
    * @since 3.10
    */
  def indexesOf[T](array: Array[T], objectToFind: T): ju.BitSet = indexesOf(array, objectToFind, 0)
  ...
  /**
    ...
    * @since 3.10
    */
  def indexesOf[T](array: Array[T], objectToFind: T, startIndex: Int): ju.BitSet = {
    val bitSet = new ju.BitSet
    if (array == null) return bitSet
  ...
  /**
    ...
    *         {@link #INDEX_NOT_FOUND} ({@code -1}) if not found or {@code null} array input
    */
  def indexOf(array: Array[Double], valueToFind: Double, tolerance: Double): Int =
    indexOf(array, valueToFind, 0, tolerance)
  ...
  def isSorted(array: Array[Double]): Boolean = {
    ...
    for (i <- 1 until n) {
      val current = array(i)
      if (JavaDouble.compare(previous, current) > 0) return false
      previous = current
    }
    true
  }
  ...
  def isSorted(array: Array[Float]): Boolean = {
    ...
    for (i <- 1 until n) {
      val current = array(i)
      if (JavaFloat.compare(previous, current) > 0) return false
      previous = current
    }
    true
  }
  ...
  def lastIndexOf(array: Array[Boolean], valueToFind: Boolean, startIndex: Int): Int = {
    ...
    val startPos: Int = if (startIndex >= array.length) array.length - 1 else startIndex

    for (i <- startPos to 0 by -1) {
      if (valueToFind == array(i)) return i
    }
  ...
  /**
    ...
    * @since 2.1
    */
  def lastIndexOf(array: Array[Char], valueToFind: Char): Int =
    lastIndexOf(array, valueToFind, Integer.MAX_VALUE)
  ...
  def lastIndexOf(array: Array[Char], valueToFind: Char, startIndex: Int): Int = {
    ...
    val startPos = if (startIndex >= array.length) array.length - 1 else startIndex
  ...
  /**
    ...
    *         {@link #INDEX_NOT_FOUND} ({@code -1}) if not found or {@code null} array input
    */
  def lastIndexOf(array: Array[Double], valueToFind: Double, tolerance: Double): Int =
    lastIndexOf(array, valueToFind, Integer.MAX_VALUE, tolerance)
  ...
  def lastIndexOf(array: Array[Float], valueToFind: Float): Int =
    lastIndexOf(array, valueToFind, Integer.MAX_VALUE)
  ...
  def lastIndexOf(array: Array[Int], valueToFind: Int): Int =
    lastIndexOf(array, valueToFind, Integer.MAX_VALUE)
  ...
  def lastIndexOf(array: Array[Long], valueToFind: Long): Int =
    lastIndexOf(array, valueToFind, Integer.MAX_VALUE)
  ...
  /**
    ...
    *         {@link #INDEX_NOT_FOUND} ({@code -1}) if not found or {@code null} array input
    */
  def lastIndexOf(array: Array[AnyRef], objectToFind: Any): Int =
    lastIndexOf(array, objectToFind, Integer.MAX_VALUE)
  ...
  def lastIndexOf(array: Array[AnyRef], objectToFind: Any, startIndex: Int): Int = {
    ...
    if (objectToFind == null) for (i <- startPos to 0 by -1) {
      if (array(i) == null) return i
    }
    else if (array.getClass.getComponentType.isInstance(objectToFind)) for (i <- startPos to 0 by -1) {
      if (objectToFind == array(i)) return i
    }
  ...
  def lastIndexOf(array: Array[Short], valueToFind: Short): Int =
    lastIndexOf(array, valueToFind, Integer.MAX_VALUE)
  ...
  def nullToEmpty(array: Array[Boolean]): Array[Boolean] =
    if (isEmpty(array)) EMPTY_BOOLEAN_ARRAY
    else array

  def nullToEmpty(array: Array[JavaBoolean]): Array[JavaBoolean] =
    if (isEmpty(array)) EMPTY_BOOLEAN_OBJECT_ARRAY
    else array

  def nullToEmpty(array: Array[Byte]): Array[Byte] =
    if (isEmpty(array)) EMPTY_BYTE_ARRAY
    else array

  def nullToEmpty(array: Array[JavaByte]): Array[JavaByte] =
    if (isEmpty(array)) EMPTY_BYTE_OBJECT_ARRAY
    else array

  def nullToEmpty(array: Array[Char]): Array[Char] =
    if (isEmpty(array)) EMPTY_CHAR_ARRAY
    else array

  def nullToEmpty(array: Array[Character]): Array[Character] =
    if (isEmpty(array)) EMPTY_CHARACTER_OBJECT_ARRAY
    else array
  ...
  def nullToEmpty(array: Array[Class[_]]): Array[Class[_]] = {
    if (isEmpty(array)) EMPTY_CLASS_ARRAY
    else array
  }

  def nullToEmpty(array: Array[Double]): Array[Double] = {
    if (isEmpty(array)) EMPTY_DOUBLE_ARRAY
    else array
  }

  def nullToEmpty(array: Array[JavaDouble]): Array[JavaDouble] = {
    if (isEmpty(array)) EMPTY_DOUBLE_OBJECT_ARRAY
    else array
  }
  ...
  def nullToEmpty(array: Array[JavaFloat]): Array[JavaFloat] = {
    if (isEmpty(array)) EMPTY_FLOAT_OBJECT_ARRAY
    else array
  }

  def nullToEmpty(array: Array[Int]): Array[Int] = {
    if (isEmpty(array)) EMPTY_INT_ARRAY
    else array
  }

  def nullToEmpty(array: Array[Integer]): Array[Integer] = {
    if (isEmpty(array)) EMPTY_INTEGER_OBJECT_ARRAY
    else array
  }

  def nullToEmpty(array: Array[Long]): Array[Long] = {
    if (isEmpty(array)) EMPTY_LONG_ARRAY
    else array
  }

  def nullToEmpty(array: Array[JavaLong]): Array[JavaLong] = {
    if (isEmpty(array)) EMPTY_LONG_OBJECT_ARRAY
    else array
  }

  def nullToEmpty(array: Array[Any]): Array[Any] = {
    if (isEmpty(array)) EMPTY_OBJECT_ARRAY
    else array
  }

  def nullToEmpty(array: Array[Short]): Array[Short] = {
    if (isEmpty(array)) EMPTY_SHORT_ARRAY
    else array
  }

  def nullToEmpty(array: Array[JavaShort]): Array[JavaShort] = {
    if (isEmpty(array)) EMPTY_SHORT_OBJECT_ARRAY
    else array
  }

  def nullToEmpty(array: Array[String]): Array[String] = {
    if (isEmpty(array)) EMPTY_STRING_ARRAY
    else array
  }
  ...
  /**
    ...
    * @since 2.1
    */
  def remove(array: Array[Boolean], index: Int): Array[Boolean] =
    remove(array.asInstanceOf[Any], index).asInstanceOf[Array[Boolean]]
  ...
  /**
    ...
    * @since 2.1
    */
  def remove(array: Array[Byte], index: Int): Array[Byte] =
    remove(array.asInstanceOf[Any], index).asInstanceOf[Array[Byte]]
  ...
  /**
    ...
    * @since 2.1
    */
  def remove(array: Array[Char], index: Int): Array[Char] =
    remove(array.asInstanceOf[Any], index).asInstanceOf[Array[Char]]
  ...
  /**
    ...
    * @since 2.1
    */
  def remove(array: Array[Double], index: Int): Array[Double] =
    remove(array.asInstanceOf[Any], index).asInstanceOf[Array[Double]]

  def remove(array: Array[Float], index: Int): Array[Float] =
    remove(array.asInstanceOf[Any], index).asInstanceOf[Array[Float]]
  ...
  /**
    ...
    * @since 2.1
    */
  def remove(array: Array[Int], index: Int): Array[Int] =
    remove(array.asInstanceOf[Any], index).asInstanceOf[Array[Int]]

  def remove(array: Array[Long], index: Int): Array[Long] =
    remove(array.asInstanceOf[Any], index).asInstanceOf[Array[Long]]
  ...
  /**
    ...
    * @since 2.1
    */
  private def remove(array: Any, index: Int)(implicit d: DummyImplicit) = {
  ...
  private[lang3] def removeAll(array: Any, indices: ju.BitSet)(implicit d: DummyImplicit): Any = {
    if (array == null) return null
    ...
    while ({ set = indices.nextSetBit(srcIndex); set } != -1) {
      count = set - srcIndex
      if (count > 0) {
  ...
  /**
    ...
    * @since 3.2
    */
  def reverse[T](array: Array[T], startIndexInclusive: Int, endIndexExclusive: Int): Unit = {
    if (array == null) return
  ...
  def shift(array: Array[Boolean], startIndexInclusive: Int, endIndexExclusive: Int, offset: Int): Unit = {
    ...
    breakable {
      while (n > 1 && currentOffset > 0) {
        val n_offset: Int = n - currentOffset
        if (currentOffset > n_offset) {
          swap(array, startPos, startPos + n - n_offset, n_offset)
          n = currentOffset
          currentOffset -= n_offset
        } else {
          if (currentOffset < n_offset) {
            swap(array, startPos, startPos + n_offset, currentOffset)
  ...
  def shuffle(array: Array[Byte]): Unit = shuffle(array, new Random)
  ...
  def shuffle(array: Array[Char]): Unit = shuffle(array, new Random)
  ...
  def shuffle(array: Array[Double]): Unit = shuffle(array, new Random)
  ...
  def shuffle(array: Array[Float]): Unit = shuffle(array, new Random)
  ...
  def shuffle(array: Array[Int]): Unit = shuffle(array, new Random)
  ...
  def shuffle(array: Array[Long]): Unit = shuffle(array, new Random)
  ...
  def shuffle(array: Array[Short]): Unit = shuffle(array, new Random)
  ...
  def subarray(array: Array[Boolean], startIndexInclusive: Int, endIndexExclusive: Int): Array[Boolean] = {
    ...
    val startPos: Int = if (startIndexInclusive < 0) 0 else startIndexInclusive
    val endPos: Int = if (endIndexExclusive > array.length) array.length else endIndexExclusive
    val newSize: Int = endPos - startPos

    if (newSize <= 0) return EMPTY_BOOLEAN_ARRAY
    val subarray: Array[Boolean] = new Array[Boolean](newSize)
    System.arraycopy(array, startPos, subarray, 0, newSize)
  ...
  def subarray[T](array: Array[T], startIndexInclusive: Int, endIndexExclusive: Int): Array[T] = {
    ...
    if (newSize <= 0) {
      @SuppressWarnings(Array("unchecked"))
      val emptyArray: Array[T] = ReflectArray.newInstance(`type`, 0).asInstanceOf[Array[T]]

      return emptyArray
    }

    @SuppressWarnings(Array("unchecked"))
    val subarray: Array[T] = ReflectArray.newInstance(`type`, newSize).asInstanceOf[Array[T]]
    System.arraycopy(array, startPos, subarray, 0, newSize)
  ...
  def swap(array: Array[Boolean], offset1: Int, offset2: Int, len: Int): Unit = {
    ...
    var o2 = if (offset2 < 0) 0 else offset2
  ...
  /**
    ...
    * @since 3.0
    */
  def toArray[T: ClassTag](@SuppressWarnings(Array("unchecked")) items: T*): Array[T] = items.toArray
  ...
  def toMap(array: Array[Any]): ju.Map[Any, Any] = {
    if (array == null) return null
    val map: ju.Map[Any, Any] = new ju.HashMap[Any, Any]((array.length * 1.5).toInt)
    ...
    for (i <- 0 until array.length) {
      ...
      } else if (`object`.isInstanceOf[Array[Any]]) {
        val entry: Array[Any] = `object`.asInstanceOf[Array[Any]]
  ...
  def toObject(array: Array[Byte]): Array[JavaByte] = {
    ...
    val result: Array[JavaByte] = new Array[JavaByte](array.length)
    for (i <- 0 until array.length) {
      result(i) = JavaByte.valueOf(array(i))
    }
  ...
  def toObject(array: Array[Double]): Array[JavaDouble] = {
    ...
    val result: Array[JavaDouble] = new Array[JavaDouble](array.length)
    for (i <- 0 until array.length) {
      result(i) = JavaDouble.valueOf(array(i))
    }
  ...
  def toObject(array: Array[Float]): Array[JavaFloat] = {
    ...
    val result: Array[JavaFloat] = new Array[JavaFloat](array.length)
    for (i <- 0 until array.length) {
      result(i) = JavaFloat.valueOf(array(i))
    }
  ...
  def toObject(array: Array[Short]): Array[JavaShort] = {
    ...
    val result: Array[JavaShort] = new Array[JavaShort](array.length)
    for (i <- 0 until array.length) {
      result(i) = JavaShort.valueOf(array(i))
    }
