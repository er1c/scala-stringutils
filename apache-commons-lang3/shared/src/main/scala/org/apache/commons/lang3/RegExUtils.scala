...
object RegExUtils {
  /**
    ...
    * @see java.util.regex.Pattern
    */
  def removeAll(text: String, regex: Pattern): String =
    replaceAll(text, regex, StringUtils.EMPTY)
  ...
  /**
    ...
    */
  def removeAll(text: String, regex: String): String =
    replaceAll(text, regex, StringUtils.EMPTY)
  ...
  /**
    ...
    * @see java.util.regex.Pattern
    */
  def removeFirst(text: String, regex: Pattern): String =
    replaceFirst(text, regex, StringUtils.EMPTY)
  ...
  /**
    ...
    * @see java.util.regex.Pattern#DOTALL
    */
  def removeFirst(text: String, regex: String): String =
    replaceFirst(text, regex, StringUtils.EMPTY)
  ...
  /**
    ...
    * @see Pattern#DOTALL
    */
  def removePattern(text: String, regex: String): String =
    replacePattern(text, regex, StringUtils.EMPTY)
  ...
  /**
    ...
    * @see java.util.regex.Pattern
    */
  def replaceAll(text: String, regex: Pattern, replacement: String): String =
    if (text == null || regex == null || replacement == null) text
  ...
  def replaceAll(text: String, regex: String, replacement: String): String =
    if (text == null || regex == null || replacement == null) text
    else text.replaceAll(regex, replacement)
  ...
  /**
    ...
    * @see java.util.regex.Pattern
    */
  def replaceFirst(text: String, regex: Pattern, replacement: String): String =
    if (text == null || regex == null || replacement == null) text
  ...
  /**
    ...
    * @see java.util.regex.Pattern#DOTALL
    */
  def replaceFirst(text: String, regex: String, replacement: String): String =
    if (text == null || regex == null || replacement == null) text
    else text.replaceFirst(regex, replacement)
  ...
  /**
    ...
    * @see Pattern#DOTALL
    */
  def replacePattern(text: String, regex: String, replacement: String): String =
    if (text == null || regex == null || replacement == null) text
